namespace Azure.Messaging.ServiceBus
{
    ...
    public static class MessageExtensions
    {
        ...
        /// <param name="message"><see cref="ServiceBusMessage"/></param>
        /// <param name="configuration"><see cref="AzureStorageAttachmentConfiguration"/> object.</param>
        /// <returns><see cref="ServiceBusMessage"/> with body uploaded to Azure Storage blob.</returns>
        public static async Task<ServiceBusMessage> UploadAzureStorageAttachment(this ServiceBusMessage message, AzureStorageAttachmentConfiguration configuration)
        {
        ...
        /// <param name="message"><see cref="ServiceBusMessage"/></param>
        /// <param name="configuration"><see cref="AzureStorageAttachmentConfiguration"/> object.</param>
        /// <returns><see cref="ServiceBusMessage"/> with body downloaded from Azure Storage blob.</returns>
        public static async Task<ServiceBusReceivedMessage> DownloadAzureStorageAttachment(this ServiceBusReceivedMessage message, AzureStorageAttachmentConfiguration configuration)
        {
            var plugin = new AzureStorageAttachment(configuration);
        ...
        /// <returns><see cref="ServiceBusMessage"/> with body downloaded from Azure Storage blob.</returns>
        public static async Task<ServiceBusReceivedMessage> DownloadAzureStorageAttachment(this ServiceBusReceivedMessage message, string messagePropertyToIdentifySasUri = AzureStorageAttachmentConfigurationConstants.DefaultMessagePropertyToIdentitySasUri)
        {
